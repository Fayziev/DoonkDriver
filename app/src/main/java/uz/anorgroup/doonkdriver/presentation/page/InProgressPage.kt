...
import uz.anorgroup.doonkdriver.databinding.PageInProgressBinding
...
@AndroidEntryPoint
class InProgressPage : Fragment(R.layout.page_in_progress) {
    private val binding by viewBinding(PageInProgressBinding::bind)
